  ...
  render() {
    ...
    return (
      <div className="navBar">
        {screenSize < 768 ? (
          <>
            <Link to="/" onClick={() => this.closeMenu()} className="logoLink">
              <Logo className="logo" />
            </Link>
            <Menu
              right
            ...
            >
              <ul>
                ...
                <li>
                  <Link className="navItem" to="/recipes" onClick={() => this.closeMenu()}>
                    Recipes
                  </Link>
                </li>
                {currentUser ? (
                  <>
                    <li>
                      <Link className="navItem" to="/createrecipe" onClick={() => this.closeMenu()}>
                        Create Recipe
                      </Link>
                    </li>
                    <li>
                      <Link className="navItem" to="/" onClick={this.onSignOut}>
                        Sign Out
                      </Link>
                    </li>
                  </>
                  ...
                  <>
                    <li>
                      <Link className="navItem" to="/signin" onClick={() => this.closeMenu()}>
                        Sign In
                      </Link>
                    </li>
                    <li>
                      <Link className="navItem" to="/signup" onClick={() => this.closeMenu()}>
                        Sign Up
                      </Link>
                    </li>
                  </>
